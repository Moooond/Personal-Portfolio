...
class WPDP
{
    ...
    public function add_menu_items()
    {
        ...
        if ( current_user_can( 'manage_options' ) ) {
            ...
            $repository_tables_found = WPDP_Project_Design_Table_Model::table_exists() && WPDP_Project_Model::table_exists() && WPDP_Page_Model::table_exists();
    ...
    public function add_projects()
    {
        ...
        global  $wpdb ;
        // Check for repository tables to prevent dashboard errors.
        if ( !WPDP_Project_Design_Table_Model::table_exists() || !WPDP_Project_Model::table_exists() || !WPDP_Page_Model::table_exists() ) {
            return;
        }
