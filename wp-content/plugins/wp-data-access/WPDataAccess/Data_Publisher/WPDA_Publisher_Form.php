				...
				function test_publication() {
					if (!publication_loaded) {
						jQuery.ajax({
							...
							url: "<?php 
        echo  get_home_url() ;
        ?>/wp-admin/admin-ajax.php?action=wpda_test_publication",
							data: {
								wpnonce: "<?php 
