...
class WPDA_Data_Tables
{
    ...
    )
    {
        ...
        return $wpda_wpdataaccess_prepare_filter . "<table id=\"" . esc_attr( $table_name ) . "{$pub_id}\" class=\"display {$dataTablesClass}\" cellspacing=\"0\">" . "<thead>" . $this->show_header(
            $columns,
            $responsive,
            $responsive_cols,
            $pub_format,
