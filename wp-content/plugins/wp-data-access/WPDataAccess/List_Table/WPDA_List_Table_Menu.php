...
class WPDA_List_Table_Menu extends WPDA_List_Table
{
        ...
        if ( $this->process_bulk_action_check_action( 'bulk-selected', __( 'Empty bulk selected', 'wp-data-access' ) ) ) {
            ...
            if ( $this->process_bulk_action_check_wpnonce( 'wpda-export-' . json_encode( $this->table_name ), '_wpnonce' ) ) {
                ...
                if ( 0 < $cnt ) {
                    ...
                    $msg = new WPDA_Message_Box( [
                        'message_text' => "<a id='wpda_export_link' target='_blank' href='{$querystring}'>" . __( 'Click here to download your export file', 'wp-data-access' ) . '</a>',
                    ] );
                    $msg->box();
                    ?>
						<script type="text/javascript">
    ...
    protected function add_header_button( $add_param = '' )
    {
        ...
        ?>
				...
				><span class="material-icons wpda_icon_on_button">cloud_upload</span> <?php 
        echo  __( 'Import CSV' ) ;
        ?></a>
